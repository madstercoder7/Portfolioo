...
function Projects() {
    return (
        /**
        <section id="projects" className="w-full text-gray-200 px-6 py-16 sm:px-16">
            <div className="max-5x1 mx-auto">
                <h2 className="text-3x1 sm:text-4x1 font-bold text-white border-b-2 border-green-400 inline-block mb-10">Projects</h2>
                <div className="space-y-12">
                    <div className="bg-[#112240] p-6 rounded-lg shadow-sm hover:shadow-lg transition">
                        <h3 className="text-x1 font-bold text-white">GenProject</h3>
                    ...
                    <div className="bg-[#112240] p-6 rounded-lg shadow-sm hover:shadow-lg transition">
                        <h3 className="text-x1 font-bold text-white">Conductify</h3>
                    ...
                    <div className="bg-[#112240] p-6 rounded-lg shadow-sm hover:shadow-lg transition">
                        <h3 className="text-x1 font-bold text-white">CryptNest</h3>
        ...
        */
        ...
        <section id="projects" className="mb-16 scroll-mt-16 md:md-24 lg:mb-36 lg:scroll-mt-24" aria-label="Projects">
